...
class _MyAppState extends State<MyApp> {
  ...
  static const String tokenizationKey = "sandbox_24s8pnxn_qvp7fvw492wrk7xm"; // Your sandbox tokenization key
  static const String clientToken = "123456789..."; // Your customer client token generated by your backend
  static const String appLinkUrl = "https://your-domain.com/"; // Your website domain name or app link url if you've setup deep links
  // static const String returnUrl = "https://your-domain.com/mobile/paypal"; // return url must match Android app links
  static const String returnUrl = "com.example.flutter_braintree_example.braintree://paypal"; // return url must match Android app links
        ...
        child: ListView(
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                try {
                  // if you need to pass postal code and billing address then use startCardPaymentWithBilling
            ...
            sep,
            const Text("🔁 PayPal Subscription", style: TextStyle(fontSize: 18)),
            ElevatedButton(
              onPressed: () async {
                try {
                  final result = await Braintree.startPayPalSubscription(
                    authorization: tokenizationKey, // or clientToken
                    amount: "4.97",
                    planName: "Inspire Uplift Perks",
                    returnUrl: returnUrl,
                    hasUserLocationConsent: false,
                  );
                  showResultDialog(result);
              ...
              child: const Text("Start PayPal Subscription"),
            ),
            sep,
